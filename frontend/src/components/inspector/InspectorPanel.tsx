...
import type { NodeData, EdgeData, Provider, Protocol } from '@/types/graph';
...
function InputField({
  ...
  return (
    <input
      ...
      className="w-full px-2.5 py-2 bg-secondary border border-border-default rounded-lg text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-cyan-500/50 placeholder:text-muted-foreground"
    />
  );
}
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={cn(
          'w-full flex items-center justify-between px-2.5 py-2 bg-secondary border border-border-default rounded-lg text-sm',
      ...
      {open && (
        <div className={cn(
          ...
          <button
            ...
            className={cn(
              'w-full flex items-center gap-2 px-2.5 py-1.5 text-xs text-muted-foreground',
...
function SelectField<T extends string>({
  ...
  return (
    <select
      ...
      className={cn(
        'w-full px-2.5 py-2 bg-secondary border border-border-default rounded-lg text-sm',
      ...
      {selectedNode && (
        <>
          ...
          <div>
            ...
            <p className="text-xs font-mono text-muted-foreground px-2.5 py-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-2.5 py-2 bg-secondary border border-border-default rounded-lg text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-cyan-500/50 placeholder:text-muted-foreground resize-none"
            />
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] font-mono text-muted-foreground break-all px-2.5 py-1.5">
              {selectedNode.id}
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 mt-2 px-2 py-2 text-xs text-red-400 bg-red-500/10 border border-red-500/20 rounded-lg hover:bg-red-500/20 transition-colors"
          >
            <Trash2 size={12} />
            Delete Node
          </button>
      ...
      {selectedEdge && (
        <>
          ...
          <div>
            ...
            <p className="text-[10px] font-mono text-muted-foreground px-2.5 py-1.5">
